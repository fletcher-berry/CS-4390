...
class GbnReceiver:
        ...
        def run(self):
                ...
                while True:
                        ...
                        if not inWindow:
                                print('out of window:', message.sequenceNumber)
                                continue
                        
                        # Moving these 2 lines is the core difference between GBN and SR receivers.
                        # While the GBN sender allows more packets in flight than the receiver's
                        # receiving window, the SR sender does not.
                        # Long story short, the GBN receiver shouldn't ACK packets unless
                        # within its window; else it will be ACKing packets that may not 
                        # have been received.
